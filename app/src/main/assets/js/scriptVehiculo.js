    ...
    vehiculos.forEach(vehiculo => {
      raw = `
          <tr>
              ...
              <td>
              <button id='${vehiculo.placa}' onclick='Android.ObtenerDatos(this.id);' type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#editarModal"><i
              class="fas fa-edit"></i></button>
            <button id='${vehiculo.placa}' onclick='Android.EliminarVehiculo(this.id);' class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></button>
          </td>
          </tr>
      `;
